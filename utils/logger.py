...
class Logger:
    ...
    def __init__(self, formatter=None, log_level=config_loader.SETTING_LOG_LEVEL, syslog_address="/dev/log"):

        if config_loader.SETTING_DEBUG and not formatter:
        ...
        self.logger = logging.getLogger("yama")
        ...
        if config_loader.SETTING_DEBUG:
